...
function placeXOrO(squareNumber) {
    ...
    //This variable retrieves the html element id that was clicked.
        ...
        //squareNumer and activePlayer are concatenated together and added to array.
    ...
    function computersTurn() {
        ...
        let pickASquare;
        //This condition allows out while loop to keep trying if a square is selected already.
        while(!success) {
...
//This function parses the selectedSquares array to earch for win conditions.
...
function checkWinConditions() {
    ...
    // and 9 of the squares are selected, the code executes.
...
function disableClick() {
    ...
    //This makes out body clickable again after 1 second.
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    let x1 = coordX1,
        ...
        //This line indicates where the end of a lines x axis is.
        y2 = coordY2,
        //This variable stores temporary x axis dara we update in our animation loop.
        x = x1,
